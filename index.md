...
| [Sep 9, 2026](/morning-notes/2026-09-09-brent-clears-100-centcom-sinks-five-more-iranian-tankers-iran-hits-jordan-airbase-hormuz-shut-nasdaq-futures-red-with-the-rest-dow-minus628-tuesday-apple-ternus-foldable-1pm-10y-auction-cpi-friday){:target="_blank"} | *The oil trade stopped being a rotation this morning and that, rather than the price itself, is the note: CENTCOM destroyed five more Iranian crude carriers overnight, four in the Gulf of Oman and one near Kharg Island, taking the count to eight tankers in four days, and Iran answered by attacking roughly ten vessels near the Strait of Hormuz and firing about twenty ballistic missiles at the Al-Azraq air base in Jordan, of which Jordanian forces intercepted eighteen, sending Brent through $100 for the first time since late July and WTI up 3% to roughly $95.50; the framing everyone is using is retaliation, but the target selection is the analysis, because eight ships destroyed with crews warned off while Kharg Island itself still stands means the United States is systematically deleting Iran's ability to move crude while leaving its ability to produce it untouched, which is economic strangulation wearing the clothes of tit for tat and has a completely different price signature, since a struck refinery is a magnitude question that resolves on an engineering schedule while a destroyed export fleet is a duration question that resolves only when the political will ends, so the right way to price this is how long a policy of sinking one tanker per attempt can run rather than how many barrels are gone this week, and on that reading a two-month high is more likely the floor of a range than the top of a spike; the market's answer is visible in the futures board, where all four contracts are down together between 0.33% and 0.56% with the Nasdaq no longer the exception, and that is the single most important development of the session, because for two weeks an oil headline produced dispersion, Dow futures down and Nasdaq futures green, capital rotating out of things that move atoms and into things that sell scarce chips, whereas this morning the transmission has changed from margins to the discount rate, running crude into headline inflation, into Friday's August CPI, and into a Federal Reserve that votes on September 16 with roughly 60% priced, which means the long duration growth complex that has been treated as exempt has just lost the exemption and the two year is already at its highest since late July with the ten year at 4.808% into a ten year auction at 1:00 p.m. that is the first duration test since crude cleared a hundred; the escalation that matters most, though, is horizontal rather than vertical, because Al-Azraq is in a country that produces no oil at all, and adding a third theatre to a conflict that already spans the strait and Saudi energy infrastructure on the Red Sea flank converts a bilateral confrontation into a regional one in which the participants no longer share a scoreboard, with the immediate casualty being the Oman brokered corridor deal that Tehran described as days away twenty four hours ago and which nobody signs in the same week they put missiles into a neighbour's air base; Europe got there first, the Stoxx 600 down 0.4% to 646.84 with the DAX off about 0.5%, the CAC 0.6% and the FTSE 0.2% while energy alone rose near 1%, into an ECB that hikes to 2.50% on Thursday against an August print of 3.3% whose energy component was running at 14.3% before this leg, and Asia was quieter than any of it with the Nikkei slipping about a quarter of a percent to roughly 65,100 as the yen gave back ground to 153.58; Apple opens the Ternus era at 1:00 p.m. with a foldable expected to clear $2,000, which is an average selling price story rather than a unit story told into a consumer that just watched gasoline reprice, and the event is as much about narrative control as hardware because product cadence is the one thing a new chief executive can control while the artificial intelligence answer is still missing; on the prints, GameStop beat where nobody was looking with revenue of $790.2 million against $756.85 million expected on collectibles strength even as the top line fell 19%, adjusted earnings of $0.27 in line and the full year outlook raised, which makes the retail half of a holding entity with a $4.95 billion eBay stake worth a smaller discount than it was yesterday, Chewy delivered $3.33 billion and an in line $0.36 with fiscal 2027 revenue guidance lifted to $13.46 to $13.57 billion from a stock already down 30% year to date, Casey's beat at $7.37 against $6.82 with same store sales up 3.2% which is a useful read on the American consumer right at the fuel pump, AeroVironment reports tonight and sits directly at the intersection of unmanned systems and a conflict that has produced tanker strikes, drone attacks on Saudi energy sites and ballistic missile intercepts inside one week; and Oracle on Thursday is still the print of the week, where $638 billion of remaining performance obligations and a 93% cloud infrastructure growth bar matter far more than a $19.13 billion revenue line, with the tension entirely in financing negative $23.7 billion of free cash flow and roughly $40 billion of debt and equity at a 4.808% ten year, into options implying an 11% move*  |
