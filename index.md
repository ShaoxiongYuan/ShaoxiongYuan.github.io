...
| [Sep 2, 2026](/morning-notes/2026-09-02-dell-proves-demand-47b-revenue-58pct-eps-704-backlog-95b-guidance-raised-25b-fcf-minus47pct-10y-4814-highest-since-nov-2023-adp-38k-brent-95-nikkei-29pct-kospi-4pct-broadcom-tonight){:target="_blank"} | *Dell settled the demand argument and the bond market immediately charged it rent: fiscal second quarter revenue of $47.0 billion was up 58% against a $44.9 billion consensus, adjusted EPS of $7.04 beat $4.90 by 44%, the company booked a record $60.9 billion of AI server orders and exited with a $95.0 billion backlog against $51.3 billion three months ago, and management raised full-year revenue guidance from $167 billion to $192 billion with EPS going to $25.50 from $17.90, so there is no reading of the print in which end demand for AI infrastructure is decelerating; the margin line this note called the only informative number was answered in the company's favour and against our own call, with non-GAAP operating margin expanding to 12.6% from 7.7%, gross margin dollars up 78% to $9.9 billion and opex down 250 basis points to 8.5% of revenue, taking Citi and Bank of America to $600 targets and the highest LSEG target to $735; the single caution is free cash flow of $986 million, down 47% year on year on record revenue as capex funds capacity, which is precisely the mechanism by which the AI buildout became a bond market problem, because the boxes are financed before the backlog converts; the tape answered by taking Dell up roughly 10% pre-market, which only recovers the 7% it lost into its own print, while the ten-year touched 4.814% and its highest since November 2023, the two-year moved up to 4.40% from 4.34% so this third day of rout is no longer purely term premium, and September hike odds sit between 66% and 70% against 35% a week ago; good news is being sold across the board with Palo Alto beating on revenue and EPS and falling 5.25% then 1.78% more after hours, MongoDB growing 30.5% and guiding above consensus and falling 12%, and only GitLab up 25% on the smallest numbers of the three, which says the problem is crowded positioning rather than results; ADP added just 38,000 against 48,000 expected and the slowest pace since January and it bought nothing, because a committee anchored on six-month annualised PCE at 4.1% does not react to a 10,000 miss at a 4.2% jobless rate, while Tuesday's ISM manufacturing at 54.6 marked an eighth straight month of expansion; the Gulf escalated from cargo to combatant as the United States struck Iranian oil tankers directly for the first time under a tanker-for-tanker policy and hit IRGC air defence, radar and mine-laying capability, with Iran answering through thirteen ballistic missiles at Jordan and drones at Bahrain and Kuwait, taking Brent to roughly $95 and its highest since late July with WTI at $90.34 and only five transits through the strait on Monday against a ten-day average of fourteen; Asia sold what it owns and what it owns is AI, with the Kospi down 4.0% to 6,562.72, the Nikkei down 2.9% to 64,325.64 for a third straight loss and SoftBank off 5.9% after SB Energy's Nasdaq filing disclosed a $3.2 billion loss on $139 million of revenue against a $40 billion OpenAI bridge loan, which is the financing half of the same story Dell told from the revenue half; and Broadcom reports tonight against $29.25 billion and $3.21 with $16 billion of guided AI revenue, where the only line that moves the stock is whether the fiscal 2027 target above $100 billion gets raised after declining to do so cost it 13% in June, with Snowflake and Pure Storage alongside and payrolls Friday* |
