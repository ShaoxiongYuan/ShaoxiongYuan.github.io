...
| [Sep 1, 2026](/morning-notes/2026-09-01-global-bond-rout-jgb-10y-3pct-first-since-1996-30y-gilt-5886-highest-since-1998-us-10y-479-eurozone-cpi-33pct-energy-143pct-brent-92-nasdaq-fut-13pct-dell-tonight){:target="_blank"} | *September opened with a synchronised global bond rout and the tell is that every leg of it happened at the long end: Japan's ten-year touched 3.00% for the first time since September 1996 with the five-year at a record 2.26%, the twenty-year at 3.885% and the thirty-year set for its highest close ever near 4.18%, Britain's thirty-year gilt jumped nine basis points to 5.8856% and its highest since March 1998 with the ten-year at 5.25% and a 2008 high, the German ten-year printed 3.35% and its highest since 2011 while the French ten-year reached 4.21% and its highest since 2008, and the US ten-year pushed to roughly 4.79% and its highest since January 2025 with the thirty-year at 5.27% on its worst run since 2006; the two-year barely moved anywhere, which inverts Friday's post-Warsh bear flattening into a global bear steepening and makes this a term premium and fiscal repricing rather than a repricing of any central bank's next meeting, with US debt past $40 trillion, hyperscaler dollar debt more than doubled since last September to above $360 billion and Morgan Stanley looking for roughly $570 billion of AI-related issuance this year all competing for the same duration bucket, which is also why Nasdaq futures fell 1.31% against the S&P's 0.66%; Bloomberg's global government debt gauge yields 3.72% and its highest since 2008, TD called it a genuine regime change and SocGen said the Gulf conflict effectively killed the idea that Warsh's hawkishness would stabilise yields; the eurozone flash print gave the rout its inflation alibi at 3.3% from 2.9%, but the composition says otherwise because energy accelerated to 14.3% from 10.3% and accounts for the entire increase while services inflation actually FELL to 3.0% from 3.3%, so the core is still cooling under an energy shock the ECB has no instrument for, with Dutch TTF gas at EUR 71.30 per megawatt hour and its highest since March, European gas up roughly 130% this year and storage 62% full against a five-year average seventeen points higher; the Gulf supplied the barrels behind it as two tankers were struck eight minutes apart on Monday night, the Saudi-flagged Sidr seventeen nautical miles northeast of Khasab and the South Korean-owned Senegal Prosperity by three projectiles, taking Brent to $92 and WTI to $87.98 with transits still below half of pre-war levels while Trump called it a relatively little war and promised to hit Iran hard; gold fell a third consecutive session to $4,406.50, having now declined on a hawkish Fed chair, on a shooting war and on a global fiscal repricing, which retires the debasement trade as an explanation for anything; Japan is the sharp end with the BOJ at 1% meeting September 17 and 18, a hike to 1.25% priced at 73% on one caliber and 80% to 90% on another, the yen at 160 and Bessent publicly telling Tokyo its next move should be a rate hike; Asia sold duration through tech with Tokyo Electron down 4.6%, Advantest 2.9% and Fujikura 3%, Hong Kong the weakest major at 25,329.73, and Korea the exception again as the Kospi closed up 0.23% at 6,835.8 on Samsung and SK Hynix buybacks with all three investor groups net sellers, while European equities sat unchanged against their own record bond yields; and Dell reports tonight against roughly $45 billion and $4.90 off a record $51.3 billion AI backlog, where the only line carrying information is the Infrastructure Solutions Group margin rather than the backlog, with ISM manufacturing at 10am against 55.2 expected, Broadcom Wednesday and payrolls Friday* |
