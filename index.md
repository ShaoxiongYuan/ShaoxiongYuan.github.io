...
| [Sep 4, 2026](/morning-notes/2026-09-04-payrolls-162k-triples-a-53k-consensus-but-wages-cool-to-31pct-and-september-moves-only-to-52-58pct-2y-441-gold-minus2pct-dxy-9927-nvidia-buys-hugging-face-129b-samsara-plus15pct-vw-cuts-50000){:target="_blank"} | *The number the whole week was built around came in at three times consensus and the meeting it was supposed to decide moved by about five percentage points: August payrolls rose 162,000 against a 53,000 Dow Jones estimate and a 56,000 Reuters estimate, the unemployment rate held at 4.1% for a third month, and the revisions did more damage to the prevailing narrative than the headline did, with June lifted 11,000 to 31,000 and July restated from a reported loss of 23,000 to a gain of 21,000, which means the first outright monthly job loss of the expansion, the print that took September hike odds into the low thirties in early August and underwrote a month of "the Fed cannot hike into a contracting labour market" positioning, simply never happened; against that, average hourly earnings rose 0.3% on the month to $37.75 and only 3.1% over the year, the softest wage reading of the cycle, and that is the entire release in one line, because a committee under Kevin Warsh is contemplating a hike aimed at inflation rather than at overheating employment, so a labour market hiring 162,000 people while paying them 3.1% more than a year ago withholds precisely the variable that would have supplied permission; September travelled only from roughly 50% after Waller's dovish Thursday remarks to somewhere between 52% and 58% by caliber, against 63% before he spoke, so a three times beat bought about five points while a Jackson Hole keynote containing no data at all bought more than twenty, and the curve confirmed the reading with a bear flattening in which the two-year did all the work at 4.41%, up about six basis points, the ten-year added under two to 4.79% and the thirty-year sat unchanged near 5.23%, the exact inverse of Monday's global term premium steepening and a reminder that on the single most important data day of the month the long end did essentially nothing; the dollar took the print at face value at 99.27, gold fell 1.98% to $4,384.91 in its third consecutive session of behaving like a pure real rate instrument, and crude went the other way with WTI under $90 despite only six Hormuz transits on Wednesday against a ten-day average near thirteen, because the marginal barrel is now being priced out of Caracas rather than Tehran after the White House published the structure of a twenty-five year Venezuela arrangement giving the Pentagon a 35% stake in NABEP, the State Department a guarantee on 20% of output at cost and Chevron a $7 billion five-year plan toward 600,000 barrels per day; the overnight corporate tape was the cleanest evidence yet that this market pays for revenue it can see and discounts everything else, with Samsara up 15% on revenue of $508.4 million growing 30%, ending ARR of $2.125 billion and record additions of 242 customers above $100,000 and 20 above $1 million, Zscaler adding only about 4% after redeeming the 31% single-day collapse that followed its May guide with 25% growth, a record 24% adjusted operating margin and fiscal 2027 guidance above the conservative bar, Guidewire down 14.5% on a light quarterly guide and Lululemon down 18% on a third guidance cut of the year with Americas comparable sales at minus 12%; Nvidia confirmed a $12.9 billion acquisition of Hugging Face, its second largest ever, buying the neutral repository through which eighteen million developers reach three million models, which is ownership of the choke point rather than a longer forecast and is worth more in a market repricing duration, as Broadcom demonstrated by guiding fiscal 2028 AI revenue to $230 billion and falling 3% over a $230 million quarterly shortfall; and two Chinese chokepoints closed on the same morning three weeks before Xi lands in Washington, with Reuters reporting that some Chinese rare earth suppliers have refused US shipments since Beijing sanctioned the Responsible Business Alliance in early August, lifting MP Materials and Energy Fuels around 3%, while the FCC drafts an import ban on Chinese optical transceivers that carry roughly sixty percent of global volume, landing forty-eight hours after Ciena reported optical revenue up 46% with four and a half points of gross margin expansion* |
