...
| [Aug 31, 2026](/morning-notes/2026-08-31-us-iran-exchange-strikes-first-in-a-month-brent-9036-but-gold-falls-and-september-hike-odds-rise-to-604pct-california-kills-utility-liability-relief-eix-pcg-17pct-china-pmi-498-kospi-round-trips-35pct){:target="_blank"} | *The war restarted overnight and only the oil market traded: US forces struck two IRGC rocket launchers on Larak Island after the Guard was seen preparing to fire rockets carrying sea mines into a strait the Navy had just finished clearing, and Iran answered hours later with ballistic missiles at King Hussein and Al Azraq in Jordan and dozens of drones at Al Menhad in the UAE, the first exchange in a month of a war now six months old; Brent added 2.56% to $90.36 and touched above $91 with WTI up 2.71% at $85.66, but gold FELL to $4,444.91, the dollar eased to 99.558, the VIX sat at 15.35 and September hike odds ROSE to 60.4% from roughly 56%, which is the whole call, because after Warsh put six-month annualised PCE at 4.1% against a twelve-month 3.7% a Gulf supply shock lands on the inflation side of the mandate rather than the growth side and inverts the reflex every oil spike has traded on for twenty years, with the gold non-reaction the cleanest evidence that the debasement bid was monetary rather than geopolitical; bigger in dollar terms than anything in the Gulf was Sacramento, where the legislature adjourned without Newsom's wildfire cost-shift, leaving SB 492 as a fast-pay scheme with no subrogation relief, no damages cap and an unchanged $18 billion fund, taking Edison down 20% and PG&E 19% pre-market with Mizuho cutting EIX to $70 from $86, BMO cutting PCG to $21 from $28 and Sempra cut alongside, which is a repricing of the regulatory compact underneath the entire AI-power thesis; China's manufacturing PMI beat at 49.8 against 49.7 with new orders jumping to 50.6 from 48.5 and export orders back above fifty, but employment fell to 48.7 and non-manufacturing contracted at 49.0, so factories are stabilising while the consumer is not, and Shanghai's 0.86% gain to 3,986.30 was a banks-led policy rally on a property overhaul that protects lenders at developers' expense; Korea gave the most informative tape of the session, opening down 2.58%, falling 3.55% to 6,547.76 and closing UP 0.46% at 6,820.02 on Samsung and SK Hynix; and in AI capital markets Anthropic is reported to be targeting an IPO that matches or beats SpaceX's $86.2 billion record while OpenAI moves to cut Cursor off on November 12 after SpaceX's $60 billion Anysphere deal, with Dell Tuesday, Broadcom Wednesday and payrolls Friday still the week* |
