...
| Date | Brief |
| ---- | ----- |
| [Sep 1, 2026](/aluminum-market-daily/2026-09-01-al2610-clears-all-six-24075-plus155-highest-since-aug-12-london-shut-for-the-bank-holiday-alumina-reclaims-four-of-six-2687-on-record-oi-minus74424-pmi-49-8-basis-minus105){:target="_blank"} | *The three-edition price drought ended with the strongest session of the month and the single most important cross-check on it does not exist, because London was shut: AL2610 closed 24,075 (+155, +0.65%), the highest close since August 12, clearing all six of its own moving averages at once by between 164.25 and 499.67, improving the retracement of the August 3–12 advance from 57.4% to 33.3% and taking the 60-session close percentile to 87.9% — answering the prior watchlist's primary question about an MA20 held by only 30.75 by widening that clearance five-fold; but the settlement rose only 30 against a close-to-close of 155, open interest rose only 618 lots against a 248,527-lot book, and the night session opened ten above the close, printed 24,095 (the highest since August 17) and handed back 80 to finish at 24,015 with open interest down a further 3,236, so the advance was covered into rather than bought into; the spot column reversed its sign without reversing its message, because all nine calibers rose and Chalco raised all four regions after cutting all four on Friday — yet the best managed +70 against +155, so the basis blew out from −20 to −105 and all three South China spreads narrowed for a third consecutive session, the precise test the prior edition set, taking 'South China tightness is structural' from fading to faded; alumina produced the sharpest contradiction, AO2610 closing 2,687 (+39, +1.47%) and reclaiming four of six averages after five sessions beneath all of them, but on open interest down 74,424, a new record beating the −52,356 set two sessions earlier — two record liquidations in three sessions, both into rising prices, which is the short-covering fork the prior watchlist named, and its discriminating test is only half-passed because Chalco's five regional listings were not raised; China's August manufacturing PMI at 49.8 beat a 49.7 consensus and July's 49.2 with new orders jumping to 50.6 from 48.5, output 50.4, export orders back above fifty and supplier deliveries shortening for the first time in seven months, giving the demand column two corroborating legs for the first time since July, while the prior edition's ⊘-flagged calendar caliber of 49.5 was wrong by 0.3; and crude flipped sides outright, Brent +2.71% to $90.49 on the first US-Iran military exchange in a month, reversing the prior edition's unambiguously bearish energy call — though gold's −0.26% says the market read an inflation shock, which is the side that puts the Fed back in play* |
| [Aug 31, 2026](/aluminum-market-daily/2026-08-31-rusal-moves-to-mothball-2-1mt-of-alumina-30-7pct-of-its-own-output-plus-the-subr-mine-guinea-caps-exports-at-150mt-minus25pct-non-ferrous-profits-plus91-8pct-and-the-august-pmi-lands-after-the-cut-off){:target="_blank"} | *A third consecutive edition without a new price — nothing has traded since the August 28 night session closed at 01:00 Saturday and this brief is written before Monday's 09:00 open, with Westmetall's most recent row still August 28 as the independent proof — so the entire value is that the alumina column just received the largest single supply item this brief has ever carried: RUSAL has written to Prime Minister Mishustin proposing to mothball the Pikalyovo (PGLZ), Bogoslovsk and Ural alumina refineries plus the Severouralsk bauxite mine (SUBR), covering 2.1 million mt of 2025 alumina output or 30.7% of the company's own total, on assets that lose $800 million a year and would need $1.8 billion to restore, with RUSAL stating outright that buying alumina externally may now be cheaper than making it; three qualifications belong as prominently as the headline, because it is a PROPOSAL in a letter with no timeline and no government answer, because the transmission to AO2610 is indirect and partly runs the wrong way (these are Russian tonnes feeding RUSAL's own smelters, and a mothballed RUSAL becomes an additional seaborne BUYER rather than a withdrawn seller), and because China's installed alumina capacity exceeds 110 million mt with H1 output still rising; Guinea's export cap now has a number too — a ~150 million mt/yr target against 183 million in 2025, a ~25% managed cut that one caliber converts into a 25-million-tonne Chinese deficit from a country supplying ~80% of China's imported bauxite — so the forward alumina book is cut or capped in five places (Yarwun, Alcoa, Alunorte, Guinea, RUSAL) while AO2610 still sits at 2,648, below all six averages and below both cost calibers of 2,718 and 2,826.21; against that, China's January–July industrial profits rose 17.6% to 4.58 trillion yuan with July alone +11.2% and non-ferrous smelting and rolling up 91.8%, corroborated in cash by Yunnan Aluminium's H1 net profit +177.61% to 7.684 billion yuan and Chalco's +67.91% to 11.871 billion — a smelter earning 91.8% more sitting on a raw material below its own cost is the whole chain margin in one link; two prediction markets price September below the futures strip (Kalshi 48%, Polymarket 49% against CME's 55.7–60%) while the December caliber that actually drives the dollar is still above 70% and essentially unchanged, which is why the dollar broke to 99.5–99.68 and not 101; and China's August manufacturing PMI publishes at 09:30 inside the writing window and after the data cut-off, so it is NOT confirmed here and a single uncorroborated calendar caliber of 49.5 must not be read as the print* |
| [Aug 30, 2026](/aluminum-market-daily/2026-08-30-weekend-august-processing-pmi-48-7pct-plus6-5-points-from-42-2-still-contraction-billet-143kt-five-year-high-with-fees-rising-as-metal-fell-cast-alloy-second-build-westmetall-confirms-246725-and-gold-closed-minus3-13pct){:target="_blank"} | *Weekend Edition: a Sunday brief adds no price and every moving average is unchanged by construction, so the value is that the demand column produced its first directionally positive evidence in four weeks while the physical stock series moved the other way at the same time — China's August aluminium processing PMI printed 48.7% against July's 42.2%, a 6.5-point gain and the largest single-month improvement on the series with SMM expecting a return to expansion in September, but it is still BELOW 50 and therefore still contraction, SMM's own words are "weak recovery" with "notable divergence across segments", the August sub-sector table was not retrievable so the breadth cannot be verified, and the weekly operating rates over the same window (extrusion 50.6% and falling, sheet/strip flat, foil +0.3pp, wire and cable +0.6pp) do not corroborate it; against that, two physical series added this edition are unambiguously bearish — billet inventory at 143,000 mt is the highest for the period in FIVE YEARS with Foshan 66,000 and Wuxi 26,500, and its processing fees ROSE in every region and gauge (Foshan +150, Wuxi +140/+200, Nanchang +250) in a week SMM A00 fell roughly 520 yuan, which is supplier margin defence rather than buyer competition, while cast alloy at 28,100 mt is now confirmed as a second consecutive and accelerating build; London was verified rather than relayed for the first time, with Westmetall's official table reproducing six consecutive sessions without a single revision, confirming simultaneously a bearish curve (the contango reversing its entire three-step collapse from $3.50 back to $19.00, falsifying the nearby-tightening case this brief itself advanced) and a bullish stock (246,725 mt, a new low of the run); the macro column requires one correction — gold CLOSED down 3.13% at $4,456 for its worst session of the year, not the −0.94% carried, with silver −4.24%, so the hawkish shock was more than three times larger than reported, which makes aluminium's $18 gain on London's post-speech electronic close a STRONGER non-confirmation, while the bear flattening (2y +23bp on the week to 4.348%, 30y −6bp to 5.21%, 2s30s 115 → 86) shows the long end paying for a credible inflation target; supply is net bullish with Qatalum quantified at roughly 60% of nameplate for the first time and China's smelters cited at a 98.4% operating rate that leaves no domestic elasticity; and both policy channels escalated in opposite directions, Canada's September 8 steel and aluminium counter-tariff going from 25% to 50% across more than 300 metals products naming aluminium bars against a new US sanctions wave, a tanker attacked in the strait within hours and Rezaei threatening to halt flows entirely — with China's August manufacturing PMI on Monday against a ~49.6 consensus and July's 49.2* |
| [Aug 29, 2026](/aluminum-market-daily/2026-08-29-weekend-all-six-averages-reclaimed-23920-first-since-aug-12-not-one-of-nine-spot-calibers-rose-basis-collapses-to-minus20-alumina-low-lasts-one-session-2648-oi-minus52356-warsh-doubles-september-inside-the-night-session){:target="_blank"} | *Weekend Edition: the primary test was passed a second time and this time it took the whole board — AL2610 closed 23,920 (+100, +0.42%), which is 30.75 above an MA20 that itself ROSE 15.00 to 23,889.25, putting every one of the six averages behind a day-session close for the first time since August 12, exactly as the prior watchlist specified, with open interest rising for the first time in three sessions; but the physical did the exact opposite and that is the hardest fact in the edition, because against a board up 100 NOT ONE of nine spot calibers rose, Chalco cut all four regional producer quotations, and the basis collapsed 120 points from a +100 premium to a −20 discount while all three South China spreads narrowed for a second consecutive session — the precise condition the prior edition set for downgrading its own structural claim; alumina's series low lasted exactly one session, AO2610 closing 2,648 (+34, +1.30%) with open interest DOWN 52,356, the largest single-session decline this brief has recorded; London went from one of six averages to three exactly as the prior watchlist said, but the contango repaid its entire three-step collapse in a single session from $3.50 back to $19.00, overturning the nearby-tightening case, while stocks moved for the first time in four prints to a new run low of 246,725 mt; and Warsh's first Jackson Hole keynote landed at 22:00 Beijing inside the night session, repricing September from 34.4% to roughly 55.7–59% and breaking the dollar out 0.52% to 99.677, yet the LME electronic 3M closed $18 higher at $3,242 after the speech, which is the edition's cleanest non-confirmation* |
...
| Date | Headline |
| ---- | -------- |
| [Sep 8, 2026](/morning-notes/2026-09-08-war-moves-from-ships-to-wells-houthis-hit-jizan-abha-najran-73-wounded-saudi-halts-operations-brent-99-opec-has-no-lever-canada-50pct-tariffs-live-yen-15289-nikkei-minus17pct-novartis-minus12pct){:target="_blank"} | *The Gulf conflict stopped being a shipping story this morning and became a production story, which is the whole note: Houthi ballistic missiles and drones struck Aramco facilities at Jizan, Abha and Najran along with King Khalid Air Base at Khamis Mushait, wounding 73 people including women and children, and the Saudi energy ministry confirmed that operations at some facilities have been halted, taking Brent to a seven-week high between $98.62 and $99.73 and WTI to roughly $93, and the reason this escalation is categorically different from the six weeks of tanker attacks before it is arithmetic rather than emotion, because a blocked strait delays barrels while a damaged facility deletes them; worse, the geography is the story, since Jizan, Abha and Najran sit on and behind Saudi Arabia's southwestern Red Sea flank rather than the Gulf coast, which is precisely the coastline the East-West Pipeline runs to at Yanbu as the institutional answer to any Hormuz closure, so the market is no longer pricing one chokepoint with a workaround but a chokepoint and its workaround under simultaneous threat from two different actors, and it lands forty-eight hours after OPEC+ left quotas flat for the rest of 2026 having already completed the rollback of the entire 1.65 million barrel voluntary cut, meaning the one organisation whose function is to absorb exactly this shock spent Sunday confirming it has nothing left to absorb it with, which makes a move of only about one and a half percent an underreaction rather than an overreaction and puts $100 Brent in the reference case into the September 16 meeting rather than in the tail; the offsetting event is diplomatic and close, with Iran saying an Oman deal on managing Hormuz shipping is days away including maps and a temporary safe corridor alongside a maritime exclusion zone to be declared outside the strait, which is bearish for crude in the narrow sense that transits resume and bullish for Iranian leverage in every other sense, because a corridor operated by permission can be closed by permission; the futures board compresses the entire morning into three numbers, Dow futures down 344 to 389 points or 0.64% to 0.78%, S&P futures down about a quarter of a percent and Nasdaq futures green, because Canada's retaliation took effect at duties of 15% to 50% on roughly $27.6 billion of American goods with steel, aluminium, iron, furniture and clothing at the full 50% plus dairy, agricultural equipment, paper, appliances and electronics, and a tariff schedule stacked on a crude price near $100 is a tax on exactly the industrial, transport and consumer complex that dominates the Dow and close to irrelevant for the semiconductor and software complex that dominates the Nasdaq 100, which is the same layered rotation of the past fortnight arriving through a different door, with SanDisk bid pre-market on reports that large cloud and AI customers are locking multi-year NAND supply as far out as 2031 against $42 billion of contract revenue already booked, more than a third of fiscal 2027 output pre-sold and no new wafer capacity before 2027 or 2028 while demand compounds above 20%, and the quiet confirmation that this has become structural rather than thematic is that Dell, Palo Alto, Arista and SanDisk enter the S&P 100 on September 21 displacing Honeywell Aerospace, Nike, Simon Property and Colgate-Palmolive, because index committees are slow and mechanical and only act once the reallocation has already happened; the risk nobody is pricing is Japan, where the Nikkei fell 1,130.51 points to 65,269.29, down 1.70%, handing back four fifths of Monday's memory-led 2.12% rally in a single session not on chips but on the currency, the yen strengthening as much as 1% to 152.89 after gaining 1.2% on Monday to reach a seven-month high on hardening expectations of a Bank of Japan hike on September 18, which means two policy tightenings in the world's largest and third largest bond markets inside the same five-day window, with the Fed deciding September 16 at 58% to 66% priced, a ten-year JGB already through 3% for the first time in roughly three decades and a yen carry trade that funds a meaningful share of global risk leverage being unwound in front of both, a positioning risk rather than a thesis risk and the two get confused most often at exactly this point in a move; Novartis fell about 12%, its steepest single-day decline since March 2020, after del-desiran missed its primary endpoint in the Phase III HARBOR study in myotonic dystrophy type 1, a third setback in seven days following pelacarsen's failure to reduce cardiovascular events despite lowering lipoprotein(a) across 8,323 patients and a clinical hold on rap-cel after patient deaths, which is not a run of bad luck but a readout on how much of the valuation was pipeline optionality rather than marketed revenue, and the Lp(a) result is the more consequential one for the sector because it refutes a biomarker rather than a molecule, with Amgen cut to Market Perform on the olpasiran read-across and Dyne and Sarepta lower on the myotonic dystrophy read; GameStop reports tonight with the numbers already known from its August 31 pre-announcement, sales falling about a fifth to $780 to $800 million on the Switch 2 comparison, store closures and the France divestiture while net income nearly doubled to $290 to $310 million on roughly $238 million of gains from an eBay position now worth $4.947 billion, which values the company as a holding entity that happens to run stores; and Oracle on Thursday remains the print of the week, where remaining performance obligations of $638 billion, up 363% and up $85 billion sequentially, matter far more than a $19.13 billion revenue line, with the real tension in the funding, since fiscal 2026 free cash flow was negative $23.7 billion on $32 billion of operating cash flow against $55.7 billion of capital expenditure and roughly $40 billion of debt and equity to be raised this year, into a stock down about 18% year to date and options implying an 11% move, which is a market that has already decided the financing question is harder than the demand question*  |
| [Sep 7, 2026](/morning-notes/2026-09-07-labor-day-asia-reprices-memory-without-us-kospi-plus46pct-sk-hynix-plus83pct-nikkei-66400-inventories-under-10-days-us-sinks-three-iranian-tankers-brent-97-opec-holds-afd-438pct-cpi-friday){:target="_blank"} | *The most important repricing of the AI trade in a month happened on a day American investors could not participate in it, because with the NYSE, the Nasdaq and the cash Treasury market all shut for Labor Day and equity futures closing early at 1:00 p.m. Eastern, Asia went ahead without them: the KOSPI rose 4.6% with SK Hynix up 8.3% and Samsung up 5.7%, both to multi-month highs, and the Nikkei added 2.12% or 1,378 points to 66,399.84 on Kioxia up 7.93%, SoftBank up 6.82%, Advantest, Fujikura and Tokyo Electron, and the trigger was not a headline but an inventory number, KB Securities reporting that memory stockpiles at both Korean producers have fallen below ten days of supply, a level with no modern precedent, arriving on top of Q3 contract prices tracking 13% to 18% higher, industry DRAM revenue up 59.5% quarter on quarter in Q2, SK Hynix describing HBM, DRAM and NAND capacity as essentially sold out for 2026 and Micron having exited consumer memory altogether while guiding its fiscal fourth quarter toward roughly $50 billion, which matters because inventory below ten days is not a demand signal at all, it is a pricing power signal, since a supplier holding a week and a half of finished goods has neither the ability nor the incentive to smooth a price cycle and simply sets contract terms instead, a condition that persists until new capacity lands and the capacity capable of breaking it is at least eighteen months away, so this leg deserves to be treated differently from the three previous AI rallies that faded, with the honest qualifications being that a 4.6% single-day move in a national index is a crowd arriving at once rather than a calm accumulation, and that the same shortage is an input cost for the layer everyone has spent two years calling the winner, already visible in Nvidia's gross margin path toward 71%; the weekend meanwhile moved the Gulf conflict up a rung, from cargo to state assets and naval platforms, when the IRGC fired ballistic missiles at a US carrier and a guided missile destroyer, both of which evaded without casualties, and CENTCOM answered by permanently disabling the crude carriers M/T Downy off Kharg Island and M/T Stark 1 near Jask and destroying the M/T Kylo near the Gulf of Oman, with Tehran calling it a war crime, claiming three US-linked ships in return and preparing to publish a restricted shipping zone and a proposed international corridor while tying any commitment to keep the strait open to a halt in American strikes, which is an attempt to convert a military stalemate into a negotiated toll booth on global crude, and the tell is that Brent only went to roughly $97 and WTI to about $92, a move under one percent on a weekend of sunk tankers, because the market now prices this as a slow physical drain rather than an event, rational while the ladder stays calibrated and complacent the moment a strike lands somewhere with Americans inside it; OPEC+ met Sunday and held quotas flat for the rest of 2026 after the 188,000 barrel September increase completed the rollback of the 1.65 million barrel voluntary cut, which read as a sequence rather than a decision means the cartel spent the year restoring every withheld barrel, finished in September, and now enters the fourth quarter as a price taker with no lever left against the most severe transit disruption in decades; Europe delivered the week's strangest non-reaction, the AfD taking 43.8% in Saxony-Anhalt against 17.2% for the CDU and 39 of 83 seats, the strongest postwar state result for a far-right party in Germany, landing on a Merz coalition at record low approval two weeks before Berlin and Mecklenburg-Vorpommern vote, and the DAX fell 0.3% to 0.4%, the Stoxx 600 sat at the flatline and the ten year Bund rose a single basis point to about 3.35%, correct for this week and wrong for this quarter, since German fiscal expansion is the largest single source of European growth in the 2026 and 2027 forecasts and now depends on a chancellor whose own party is describing its deepest crisis in eighty one years, with Nordex up 11.4% on a Bank of America upgrade and Novartis down as much as 3.6% after pelacarsen lowered lipoprotein(a) across 8,323 patients and failed to reduce cardiovascular death, heart attack or stroke, the cleanest possible refutation of a biomarker thesis; Hong Kong was the odd man out at minus 0.93% to 25,413.12 with Shanghai inert at 3,932.70, the year's recurring divergence between indices that own the memory and equipment layers and one weighted toward platforms, property and financials; and four sessions now separate this market from a Fed decision, with PPI and the ECB on Thursday alongside Oracle and Adobe after the close, where Oracle's remaining performance obligations at $455 billion and up 359% matter far more than a $19.13 billion revenue line and either confirm the entire memory and optical bid or break it, and an August CPI on Friday expected at 3.4% headline and 2.4% core that is simply the wrong number, because the crude move happened in September and the committee will vote on data that structurally cannot contain the impulse running in front of it, which is why the risk into Friday is asymmetric toward a hike being confirmed rather than doubted*  |
| [Sep 5, 2026](/morning-notes/2026-09-05-weekend-wrap-crude-plus95pct-on-a-strait-running-six-transits-payrolls-162k-take-september-to-59pct-fed-goes-dark-today-sandisk-plus119pct-micron-plus61pct-apple-alphabet-microsoft-all-minus2pct-ecb-thursday-cpi-friday){:target="_blank"} | *The S&P 500 moved one tenth of one percent across the week and that flat line is the least informative number of the five sessions, because underneath it the oil price quietly became the policy variable on two continents: crude added 9.5% to $91.31 on WTI and roughly eight percent to $96.28 on Brent after touching $97.36, not on a risk premium but on a physical shortage, with the Strait of Hormuz running six to eight transits a day against a normal eighty five, a VLCC passage now costing twenty million dollars, war risk claims past two billion and Iraq reduced to searching for tankers willing to make the run at all, and the tell is in the spread, since Brent's premium over WTI narrowed from about $6.14 to roughly $4.97 in a week, meaning American crude outperformed the seaborne benchmark during a Persian Gulf supply event, which is backwards on the standard template and only makes sense if the disruption is being priced as a global barrel shortage rather than a regional one; that same barrel is already inside European inflation, where the August print rose to 3.3% from 2.9% with the energy component accelerating to 14.3% from 10.3% and the ECB now near certain to hike 25 basis points to 2.50% on Thursday, while in Washington the labour half of the mandate simply stopped objecting, payrolls at 162,000 landing against a trailing twelve month average of 31,000 with June and July revised up a combined 55,000 and September odds moving from roughly 51% to somewhere between 58% and 65% by venue; the Federal Reserve's blackout begins today, which leaves exactly two inputs before the September 16 decision, Thursday's PPI and Friday's CPI, and the asymmetry nobody is discussing is that Friday's CPI covers August while the 9.5% crude move happened in September, so the committee will vote on data that structurally cannot contain the impulse now running in front of it, with average hourly earnings at 3.1% and a Chicago Business Barometer that collapsed 10.5 points to 47.1 as the only real counterweights; the curve refused to behave like an oil shock, the thirty year easing a basis point Friday to 5.25% and adding only four on the week while the two year did the work at 4.39% and the ten year led with six, and a long end that will not steepen into a 9.5% crude week is making a credibility statement about this Fed, though the dollar falling half a percent in a week hike odds rose by ten points is the awkward half of that picture; and inside equities the most actionable development of the week was invisible at the index level, because Friday saw SanDisk gain 11.9%, Marvell 7%, Micron 6.1%, AMD 4.7% and Intel 4.5% with the DRAM ETF up 6.5% and SOXX up 3.5%, while Apple fell 2.55%, Alphabet 2.10% and Microsoft 2.05% in the same session, which is not risk on or risk off but capital moving down a layer, out of platform businesses whose AI value is optionality discounted over a decade and into businesses whose AI value is a shortage priced this quarter, the arithmetic being that a ten year at 4.78% marks down terminal value while sold out high bandwidth memory capacity gets marked up on cash flows arriving inside eighteen months, and it is the same trade as Ciena's optical revenue growing 46%, Dell's $95.0 billion backlog, and shipping stocks printing fifty two week highs on scarcity of hulls; Anthropic put a number on the demand side with a $35 billion six year agreement with Nvidia-backed Lambda across a 350MW Hut 8 facility in Nueces County where Nvidia holds the lease, taking it to roughly $175 billion of cloud commitments alongside $50 billion with Fluidstack, $45 billion with Nscale and $45 billion with SpaceX, which both justifies Micron's sold out position and concentrates the financing risk on a private balance sheet, while routing AI compute procurement directly into the launch industry ahead of Starship Flight 14 no earlier than September 15; and the company prints that mattered were about companies rather than about AI, with Lululemon cutting full year revenue to $10.35 to $10.50 billion from $11.00 to $11.15 billion and EPS to $9.48 to $9.73 in a third cut since March, each following a quarter that beat on earnings and missed on sales, taking the stock down 17% to an eight year low under $100 days before Heidi O'Neill arrives from Nike, and Adobe falling 6.5% after naming Anil Chakravarthy to succeed Shantanu Narayen on December 1 while disclosing that David Wadhwani, who ran the roughly three quarters of revenue sitting in creative, is leaving, a succession announced one week before a fiscal Q3 print that now becomes a referendum on whether generative tools are taking the franchise; Oracle on the same Thursday is the most underweighted event of the coming week, since consensus near $19.13 billion and $1.30 matters far less than whether remaining performance obligations clear half a trillion from $455 billion and 359% growth, a number that either validates the entire memory and optical bid or breaks it on the same day the ECB hikes*  |
