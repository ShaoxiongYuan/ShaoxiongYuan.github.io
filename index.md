...
| [Jul 29, 2026](/aluminum-market-daily/2026-07-29-china-destock-breaks-1mt-979kt-shfe-decouples-higher-lme-slips-3149-fomc-decision-day){:target="_blank"} | *The floor this rebound has been trading on all month finally printed: SMM major-consumption-area aluminum ingot inventory fell to 979,000 mt on Monday July 27 — the cycle's first sub-1 Mt reading, −27 kt vs Thursday July 24 and −43 kt vs the prior Monday, ~486 kt off the early-May peak near 1.465 Mt — and the two boards promptly split on it: SHFE's most-traded contract (now AL2609) closed Tuesday July 28 at 23,275 CNY/mt, +0.43% with open interest up more than 4,000 lots, while LME 3M slipped to a confirmed $3,148.60/mt (−0.71%), its first close back under MA5 since the rebound began; China is trading its own tightening balance while the ex-China board digests a fourth straight down session in Brent (~$87.53, after Monday's $88.36 settle, −8.7%) and a Hormuz standoff in which Oman has floated a Malacca-style navigation mechanism Tehran has not accepted and Iran insists there are no live US talks; the dollar eased to ~101.39 off a 15-month high, leaving CME FedWatch at ~66% hold / ~34% hike into today's 2:00pm ET decision and Warsh's 2:30pm presser (no SEP, funds rate 3.50–3.75%); ex-China the stock floor is deeper still (LME 271,275 mt on July 24, the lowest since records began in January 1998; on-warrant 245,350 mt), but the cap now has a supply explanation rather than a macro one — Indonesian primary exports ran +58% YoY in Jan–May with up to 11 new smelters and 13 Mt/yr planned, and Chinese smelters are at ~99% utilization with May semis exports of 595 kt, the most since November 2024, so the ~2 Mt Gulf hole has been quietly filled; the read is floor-confirmed-cap-explained, with $3,200 unbroken on three attempts and alumina still the lone laggard (AO2609 ~2,686, −0.7%; SMM index ~2,720; four-market ~2,548).* |
