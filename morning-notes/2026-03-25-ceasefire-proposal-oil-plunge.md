...
- **Bitcoin drag:** $151M loss on crypto in a single quarter is material relative to $107M net income. If you strip out the Bitcoin mark-to-market, the operational picture is even worse.
...
- **Stock reaction:** GME fell ~1% after-hours. The beat was priced in, the revenue miss was forgiven, and the M&A silence disappointed.

---

## OIL & COMMODITIES — The Repricing Is Underway

Brent crude has fallen from $112 last Friday to $98 at yesterday's close — a 12.5% decline in three sessions. This is the most aggressive oil repricing since the pandemic:

- **Energy stocks:** XOM, CVX, OXY, HAL are all 5–10% off their war highs. The easy money in the energy trade is behind us. But we're not selling here — the supply disruptions are real and Israeli escalation risk keeps a floor.
- **Airlines:** DAL, UAL, LUV have bounced 6–8% since Monday on the jet fuel collapse. If Brent stays below $100, airlines are the biggest beneficiaries.
...
- **Gasoline:** Still $4.10–4.20 nationally. Pump prices lag crude by 2–3 weeks. Even with Brent at $98, consumers won't see relief until mid-April. The consumer confidence damage is already baked in for Q2.

| Commodity | Level | WoW Chg | Note |
|---|---|---|---|
| Brent Crude | $98–$100 | -12.5% | 3-day selloff; biggest since 2020 |
| WTI Crude | $87–$90 | -14% | Below $90 for first time in 2 weeks |
| Gold (Spot) | $3,200 | -2.7% | Pulling back from $3,290 record |
| Nat Gas (HH) | $4.80 | +8% | South Pars strike still impacting LNG supply |
| Gasoline (Avg) | $4.15 | Flat | Pump prices lag crude by 2–3 weeks |
| Bitcoin | $68,000 | -5% | Risk-on fade; correlating with equity swings |
...
| Signal | Detail | Bias |
|---|---|---|
| US proposal | 15-point framework delivered via Pakistan. Sanctions relief + nuclear rollback + Hormuz. Serious. | BULL |
| Iran counter | 5 counter-demands. Rejection of US plan BUT engagement via counter-offer = implicit acceptance of talks. | BULL |
| Strike deadline | Extended to April 6. 10 more days without US strikes on energy/power. De-escalation signal. | BULL |
| Pakistan mediation | In-person talks in Islamabad being planned for Friday. Egypt, Turkey also positioning as mediators. | BULL |
| Israel / IDF | Struck Tehran again Monday night. Not party to pause. Netanyahu operating independently. | BEAR |
| Hormuz status | Iran demands "international recognition of authority." Not proposing to keep it closed permanently. | NEUTRAL |
| Oil price | Brent below $100. 12.5% decline in 3 sessions. Market pricing higher ceasefire probability. | BULL |
| Consumer damage | CB Confidence 92.2. Expectations 65.2 (12-year low). Inflation expectations 6.2%. Structural damage done. | BEAR |
| Nuclear gap | US wants full rollback; Iran wants "peaceful rights." Hardest gap but 2015 JCPOA template exists. | NEUTRAL |
| Reparations | Iran demands war damages. US will never pay. This is a throwaway demand for negotiating leverage. | NEUTRAL |
...
Delta is the cleanest beneficiary of the oil repricing. Jet fuel is 20–25% of operating costs. A $15/bbl drop in crude translates to ~$2B+ in annualized fuel savings across the industry. DAL has the best hedging program, highest premium mix (transatlantic + Delta One), and most pricing power. If Brent stays below $100, DAL re-rates to $55–60 from $44 today.
*Risk: Ceasefire collapses; oil spikes back to $110+; consumer spending deteriorates enough to hit travel demand.*

**REDUCE — Energy Longs — Further Profit-Taking on Second Half**
We said Monday to take profits on half. Today we say take profits on the remaining half if Brent breaks below $95. The ceasefire probability has risen from 30% to 45%, the strike deadline is extended to April 6, and the market's psychology has flipped from "trade the war" to "trade the peace." Keep 25% as a tail hedge.
*Risk: Ceasefire collapses; Israel escalates against Hormuz directly; new supply disruption event.*

**SHORT — Consumer Discretionary (XLY) Puts — The Consumer Is Cracking**
Conference Board at 92.2 with Expectations at 65.2 is a recession-level signal. Inflation expectations at 6.2% mean the pain isn't over. Gasoline prices won't fall for 2–3 more weeks even with $98 Brent. Q2 earnings guidance for consumer discretionary names will be horrific. Buy XLY April puts or short individual names (NKE, SBUX, DIS).
*Risk: Ceasefire + oil crash drives gasoline back to $3.50; consumer confidence rebounds; summer travel season surprises.*

**HOLD — MU + COHR/LITE — AI Secular Winners Are Immune to This Noise**
Micron's $33.5B Q3 guide, COHR/LITE's NVIDIA partnerships, and the AI infrastructure buildout are not war-dependent stories. These names will oscillate with the tape in the short term, but the fundamental trajectories are untouched by geopolitics. Hold through the noise. Buy dips aggressively.
*Risk: Severe recession reduces datacenter capex; NVIDIA pulls back investment commitments; HBM pricing war.*
