...
snapshot:
  - { label: 'S&P 500', value: '5,645', dir: up }
  - { label: 'Nasdaq Composite', value: '+0.77%', dir: up }
  - { label: 'Dow Jones', value: '46,429', dir: up }
  - { label: 'Brent Crude', value: '$98–$100', dir: down }
  - { label: 'VIX', value: '25', dir: down }

levels:
  - { name: 'S&P 500', value: '5,645', dir: up }
  - { name: 'Nasdaq Composite', value: '+0.77%', dir: up }
  - { name: 'Dow Jones', value: '46,429', dir: up }
...
sentiment:
  - { label: 'Diplomacy / Ceasefire Odds', tone: bullish, pct: 70 }
  - { label: 'Risk Assets', tone: bullish, pct: 60 }
  - { label: 'Oil Complex', tone: bearish, pct: 42 }
  - { label: 'Geopolitical Risk', tone: neutral, pct: 52 }
  - { label: 'Defense', tone: neutral, pct: 50 }
  - { label: 'AI Infrastructure', tone: bullish, pct: 71 }
  - { label: 'Consumer Macro', tone: bearish, pct: 80 }
---
...
| --- | --- | --- | --- |
| GME | GameStop | −1% | Beat EPS (+58%), missed rev (−25%). Cohen silent on M&A. $151M BTC loss. |
| DAL | Delta Air Lines | +3% | Continuing jet fuel relief rally. Brent below $100. Best positioned airline. |
| XOM | Exxon Mobil | −2–3% | Oil selloff continues. Brent $98. Energy longs under pressure. |
| OXY | Occidental | −3–4% | Highest beta to oil decline. Giving back war premium fast. |
| LULU | Lululemon | Flat | Reports Thursday AMC. Consumer confidence collapse creates risk for guide. |
| MU | Micron | +1% | Steady. AI story transcends war noise. Post-earnings dip largely absorbed. |
| COHR | Coherent | −1% | Post-S&P 500 inclusion settling. Passive buying largely complete. |
| LMT | Lockheed Martin | −1–2% | Defence fading on ceasefire optimism. Still structurally overweight. |
| NKE | Nike | −2% | Consumer confidence collapse hits discretionary hardest. Weak China. |
| SBUX | Starbucks | −1–2% | Consumer retrenchment signal. Traffic trends at risk. |
...
| --- | --- | --- | --- |
| Wed 3/25 | All Day | Ceasefire Window Day 3 — Counter-Offers Exchanged | HIGH |
| Wed 3/25 | 8:30 AM | Durable Goods Orders (Feb) — POSTPONED to Apr 7 | LOW |
...
| Fri 3/27 | 8:30 AM | Core PCE Inflation (Feb) — THE MACRO EVENT OF THE WEEK | HIGH |
| Fri 3/27 | 10:00 AM | UMich Consumer Sentiment Final (Mar) | MED |
| Fri 3/27 | TBD | Pakistan Talks — Possible In-Person Islamabad | HIGH |
| Fri 3/27 | All Day | Ceasefire Window Day 5 (Original Deadline) | MED |
| Apr 6 | 8 PM ET | Extended Strike Deadline — NEW | HIGH |
