---
layout: morning-note
title: "All Eyes on NFP — Marvell Completes the AI Semi Hat-Trick, Brent Breaks $85"
headline: "All Eyes on NFP — Marvell Completes the AI Semi Hat-Trick, Brent Breaks $85"
date: 2026-03-06
image: /images/notes/2026-03-06.jpg
author: Steven Yuan

snapshot:
  - { label: "S&P 500",          value: "6,830.71",  dir: down }
  - { label: "S&P Futs",         value: "+0.2%",     dir: up }
  - { label: "Nasdaq 100 Futs",  value: "+0.4%",     dir: up }
  - { label: "Russell 2000",     value: "~2,020",    dir: down }
  - { label: "VIX",              value: "~22.5",     dir: down }
  - { label: "10Y Treasury",     value: "4.15%",     dir: down }
  - { label: "WTI Crude",        value: "$81.01",    dir: down }
  - { label: "Brent Crude",      value: "$85.41",    dir: down }
  - { label: "BTC",              value: "~$70,400",  dir: up }

levels:
  - { name: "S&P 500",           value: "6,830",     dir: down }
  - { name: "S&P Support",       value: "6,800",     dir: "" }
  - { name: "10Y Treasury",      value: "4.15%",     dir: down }
  - { name: "2Y Treasury",       value: "4.18%",     dir: down }
  - { name: "WTI Crude",         value: "$81.01",    dir: down }
  - { name: "Brent Crude",       value: "$85.41",    dir: down }
  - { name: "Gold Spot",         value: "~$4,980",   dir: down }
  - { name: "DXY",               value: "~104.8",    dir: down }
  - { name: "VIX",               value: "~22.5",     dir: down }

sentiment:
  - { label: "AI Infrastructure",   tone: bullish, pct: 92 }
  - { label: "Energy (E&P + Integ)",tone: bullish, pct: 85 }
  - { label: "Defense",             tone: bullish, pct: 80 }
  - { label: "Defensive Consumer",  tone: bullish, pct: 75 }
  - { label: "Equities (broad)",    tone: bearish, pct: 30 }
  - { label: "SaaS / Software",     tone: bearish, pct: 12 }
  - { label: "Airlines / Apparel",  tone: bearish, pct: 8 }
