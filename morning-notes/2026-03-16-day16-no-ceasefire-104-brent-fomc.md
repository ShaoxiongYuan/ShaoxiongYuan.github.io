...
snapshot:
  - { label: "S&P 500",          value: "6,663",      dir: down }
  - { label: "S&P Futs",         value: "+0.5%",      dir: up }
  - { label: "Nasdaq Futs",      value: "+0.6%",      dir: up }
  - { label: "Dow Jones",        value: "46,543",     dir: down }
  - { label: "WTI Crude",        value: "$100.75",    dir: up }
  - { label: "Brent Crude",      value: "$104.37",    dir: up }
  - { label: "VIX",              value: "27.29",      dir: up }
  - { label: "10Y Treasury",     value: "4.28%",      dir: up }
  - { label: "Gold",             value: "$5,130",     dir: up }

levels:
  - { name: "S&P 500",           value: "6,663",      dir: down }
  - { name: "Nasdaq Composite",  value: "22,190",     dir: down }
  - { name: "Dow Jones",         value: "46,543",     dir: down }
  - { name: "Russell 2000",      value: "2,058",      dir: down }
  - { name: "WTI Crude",         value: "$100.75",    dir: up }
  - { name: "Brent Crude",       value: "$104.37",    dir: up }
  - { name: "VIX",               value: "27.29",      dir: up }
  - { name: "10Y Treasury",      value: "4.28%",      dir: up }
  - { name: "Gold Spot",         value: "$5,130",     dir: up }

sentiment:
  - { label: "Energy (E&P)",       tone: bullish, pct: 95 }
  - { label: "Gold / Precious",    tone: bullish, pct: 92 }
  - { label: "Defense",            tone: bullish, pct: 88 }
  - { label: "AI Infrastructure",  tone: neutral, pct: 55 }
  - { label: "SaaS / Software",    tone: bearish, pct: 12 }
...
| Index | Fri Close | Futures | YTD | Context |
|---|---|---|---|---|
| **S&P 500** | 6,663 | **+0.5%** | **−6.9%** | 3rd straight losing week (−1.6%); 2026 lows in tact |
| **Nasdaq Composite** | 22,190 | **+0.6%** | **−8.4%** | Tech trying to stabilise; GTC tonight could help |
| **Dow Jones** | 46,543 | **+0.2%** | **−4.9%** | 3 straight weekly losses (−2.0% last wk) |
| **Russell 2000** | 2,058 | **+0.4%** | **−11.6%** | Small-cap hardest hit; rate sensitive + oil exposure |
| **S&P 500 Futures** | 6,671 | **+0.5%** | **—** | Pre-FOMC positioning; low conviction bounce |
| **Nasdaq Futures** | 24,535 | **+0.6%** | **—** | NVDA GTC keynote today = near-term catalyst |

## Oil, Volatility & Key Instruments

| Asset | Level | Fri Chg | 3-Wk Chg | Signal |
|---|---|---|---|---|
| **WTI Crude** | **$100.75** | **+2.1%** | **+48%** | Triple-digit era confirmed; demand destruction lag |
| **Brent Crude** | **$104.37** | **+1.2%** | **+51%** | 3rd consecutive close >$100; no Hormuz transit |
| **VIX** | **27.29** | **+0.3pt** | **+82%** | Elevated but not panic; complacency risk below 30 |
| **Gold** | **$5,130** | **+0.6%** | **+8.4%** | New ATH range; safe haven structurally bid |
| **10-Yr Yield** | **4.28%** | **+4 bps** | **+22 bps** | Inflation fear > recession fear; curve steepening |
| **DXY (USD)** | **100.22** | **+0.1%** | **+2.3%** | Dollar strong; 10-month high; EM stress deepening |
...
|---|---|---|
| **Trump: "Very complete"** | Repeated claim war is nearly won; demands surrender | **BULL** |
| **Summit delay threat** | May postpone Beijing trip; tariff truce at risk | **BEAR** |
| **Mojtaba: Hormuz stays shut** | New leader's first act is maximally hawkish; no deal signal | **BEAR** |
| **Mojtaba: Attack US bases** | Direct threat to US military assets in region | **BEAR** |
| **IDF: 3+ wks of strikes** | Expanding operations; thousands of targets remain | **BEAR** |
| **Turkey/India ship transit** | Some selective passage allowed; cracks in blockade? | **BULL** |
| **Bessent-China Paris talks** | Trade talks continue despite summit delay threat | **NEUTRAL** |
| **No Mojtaba video/audio** | New leader's legitimacy uncertain; power vacuum risk | **BEAR** |
| **700 missiles, 3,600 drones fired** | Iran's retaliatory capacity not exhausted | **BEAR** |
| **IEA reserve release** | Coordinated SPR release had zero impact on price | **BEAR** |
...
| 5 | Bessent-He Lifeng meet in Paris for pre-summit trade talks amid Section 301 probe escalation |
| 6 | ~1,000 oil tankers stranded; no AIS-confirmed vessel transit through Hormuz in either direction |
| 7 | Brent $104.37, WTI $100.75 — oil in sustained triple-digit era; IEA SPR release had no impact |
| 8 | NVIDIA GTC 2026 opens today in San Jose; Jensen Huang keynote at 1:00 PM ET — Vera Rubin, NemoClaw expected |
| 9 | FOMC meeting begins tomorrow (Mar 17-18); first meeting since war started; dot plot + Powell presser Wed 2:30 PM |
| 10 | Gold above $5,100 — new all-time high range; central bank buying + stagflation hedging |
| 11 | Iran has fired 700 missiles and 3,600 drones at US/Israeli targets since Feb 28; 3 US troops KIA |
| 12 | UK PM Starmer drew Trump's frustration for lack of immediate military support; allied unity fraying |
| 13 | EM currencies under severe pressure: Turkish lira, Pakistani rupee, South Korean won on energy import costs |
| 14 | Michigan Consumer Sentiment (prelim Mar) printed 55.5 on Friday — lowest of 2026; consumer cracking |
...
|---|---|---|
| Mon Pre-Mkt | **Market open Week 3 of conflict; positioning ahead of FOMC** | **HIGH** |
| Mon 1:00 PM | **NVIDIA GTC Keynote — Jensen Huang; Vera Rubin, NemoClaw agent platform** | **HIGH** |
| Mon All Day | NAHB Housing Market Index (Mar) | **MED** |
| Tue 8:30 AM | **Retail Sales (Feb) — pre-oil shock consumer read** | **HIGH** |
| Tue 9:15 AM | Industrial Production + Capacity Utilisation (Feb) | **MED** |
| Tue 10:00 AM | **FOMC Meeting Day 1 begins** | **HIGH** |
| Wed 8:30 AM | **PPI + Core PPI (Feb) — producer inflation; pipeline for March CPI** | **HIGH** |
| Wed 10:00 AM | Pending Home Sales (Feb) | **MED** |
| Wed 2:00 PM | **FOMC Rate Decision + Dot Plot + Economic Projections — CRITICAL** | **HIGH** |
| Wed 2:30 PM | **Chair Powell Press Conference — stagflation language = market mover** | **HIGH** |
| Thu 8:30 AM | Jobless Claims (weekly) + Philly Fed Manufacturing (Mar) | **MED** |
| Thu PM | **FDX Earnings — global shipping bellwether amid Hormuz blockade** | **HIGH** |
| Thu PM | **MU Earnings — AI memory demand vs. macro headwinds** | **HIGH** |
| Fri 9:45 AM | **S&P Global Flash PMIs (Mar) — first March activity read** | **HIGH** |

## Earnings Calendar | Week of March 16–20

| Date | Ticker | Company | When | EPS Est | Rev Est | Key Watch |
|---|---|---|---|---|---|---|
| Mon 3/16 | **XPEV** | XPeng | Pre | $0.04 | $1.8B | China EV demand; US tariff risk |
| Tue 3/17 | **PDD** | PDD Holdings | Pre | $2.41 | $14.3B | Temu growth; China consumer + tariff exposure |
| Wed 3/18 | **GIS** | General Mills | Pre | $0.91 | $5.0B | Staples demand; input cost inflation from oil |
| Wed 3/18 | **FIVE** | Five Below | Pre | $3.78 | $1.3B | Discretionary spend; consumer sentiment crash |
| Thu 3/19 | **MU** | Micron | AMC | $1.54 | $8.0B | AI DRAM/HBM demand; capex signals; key name |
| Thu 3/19 | **FDX** | FedEx | AMC | $4.56 | $21.7B | Global shipping disruption; Hormuz rerouting |
| Thu 3/19 | **ACN** | Accenture | Pre | $2.84 | $16.5B | Enterprise IT spend; deal pipeline health |
| Thu 3/19 | **NKE** | Nike | AMC | $0.29 | $11.2B | Consumer discretionary; China sales; FX drag |
| Thu 3/19 | **DRI** | Darden Rest. | Pre | $2.85 | $3.1B | Restaurant traffic; fuel cost impact on guests |
| Fri 3/20 | **LULU** | Lululemon | AMC | $6.01 | $3.6B | Premium consumer resilience; growth vs. macro |

> **⭐ MARQUEE REPORTS Micron (MU) + FedEx (FDX) on Thursday — The Two Earnings That Matter**
>
> MU: Memory/HBM demand is the purest read on AI infrastructure spend. After a 60% YoY revenue surge last quarter, consensus expects continued strength. Any demand softening = major signal that capex cycle is rolling. FDX: The global logistics bellwether. With Hormuz blockaded and tankers rerouting around Cape of Good Hope (+10–14 days per voyage), FedEx's international package and freight volumes will tell us how badly global trade is being disrupted. If FDX guides down on shipping cost inflation, the consumer discretionary unwind deepens.
...
DISCLAIMER: For internal research purposes only. Market data from Bloomberg, Yahoo Finance, TradingEconomics, CNBC, CNN, Al Jazeera as of Mon Mar 16, 2026 06:45 ET. War updates from AP, Reuters, Al Jazeera, NPR, CNN, Times of Israel. FOMC expectations from CME FedWatch, JP Morgan, TheStreet. Earnings estimates from Zacks, Investing.com.
