...
| --- | --- | --- | --- |
| S&P 500 | 5,730 | +2.7% | Gap-up on 5-day strike pause (futures level) |
| Nasdaq Composite | 20,050 | +3.1% | Tech-led relief move (futures proxy) |
| Dow Jones | 46,500 | +2.1% | Broad risk-on bid (futures level) |
| Russell 2000 | 1,920 | +2.8% | Small-cap rebound |
| WTI Crude | $96–$101 | −10% to −13% | Risk premium unwinding |
| Brent Crude | $99–$104 | −11% to −14% | Largest one-day drop since 2020-era shock |
| VIX | 26.8 | −15% | Volatility compression |
| 10Y Treasury | 4.28% | −4bp | Rates relief |
| Gold Spot | $3,210 | −2.4% | Safe-haven unwind |
