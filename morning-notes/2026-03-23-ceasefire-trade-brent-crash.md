...
snapshot:
  - { label: 'S&P 500', value: '5,730', dir: up }
  - { label: 'Nasdaq Composite', value: '20,050', dir: up }
  - { label: 'Dow Jones', value: '46,500', dir: up }
  - { label: 'Russell 2000', value: '1,920', dir: up }
  - { label: 'Brent Crude', value: '$99–$104', dir: down }

levels:
  - { name: 'S&P 500', value: '5,730', dir: up }
  - { name: 'Nasdaq Composite', value: '20,050', dir: up }
  - { name: 'Dow Jones', value: '46,500', dir: up }
  - { name: 'Russell 2000', value: '1,920', dir: up }
...
sentiment:
  - { label: 'Diplomacy / Ceasefire Odds', tone: bullish, pct: 62 }
  - { label: 'Risk Assets', tone: bullish, pct: 68 }
  - { label: 'Oil Complex', tone: bearish, pct: 35 }
  - { label: 'Geopolitical Risk', tone: bearish, pct: 70 }
  - { label: 'Defense', tone: neutral, pct: 55 }
  - { label: 'AI Infrastructure', tone: bullish, pct: 72 }
  - { label: 'Consumer Macro', tone: neutral, pct: 50 }
---
...
| --- | --- | --- | --- |
| S&P 500 Futs | 5,730 | +2.7% | Biggest gap-up since Feb 28 war start |
| Nasdaq 100 Futs | 20,050 | +3.1% | Tech leading the relief rally |
| Dow Futs | 46,500 | +2.1% | Broad risk-on |
| Russell 2000 Futs | 1,920 | +2.8% | Small caps bouncing hard |
| Brent Crude | $99–$104 | −11% to −14% | Crashed from $112; biggest single-day drop in years |
| WTI Crude | $96–$101 | −10% to −13% | Gave back nearly all of last week’s gains |
| Gold | $3,210 | −2.4% | Safe haven unwind; down from record $3,290 |
| VIX | 26.8 | −15% | Vol crushed on ceasefire hopes |
| 10Y UST | 4.28% | −4bp | Modest rate relief |
| DXY (Dollar) | 105.9 | −0.8% | Dollar weakens as risk-on returns |
| Bitcoin | $70,600 | +8.5% | Risk-on bid; bouncing from $65K weekend lows |
...
| Signal | Detail | Bias |
| --- | --- | --- |
| Trump rhetoric | 5-day strike pause. “Very good talks.” Witkoff/Kushner engaged. First genuine de-escalation signal. | BULL |
| Iran response | Denies talks occurred. Ghalibaf calls it “market manipulation.” Public posture remains hawkish. | BEAR |
| Israel / IDF | No pause announced by Israel. Lebanon operations continue. IDF not party to US-Iran talks. | BEAR |
| Oil supply | Kuwait 730K bpd still offline. Iraq FM in place. But Bessent released 140M barrels of stranded oil. | NEUTRAL |
| Hormuz status | No new incidents overnight. The 5-day pause may reduce strait targeting pressure. | BULL |
| Ceasefire odds | Market pricing ~30–40%. Real odds uncertain—Iran’s denial creates credibility gap. | NEUTRAL |
| Nuclear talks | Trump demands full uranium surrender. Iran unlikely to accept. Hardest issue on the table. | BEAR |
| Pentagon posture | Additional Marines still deploying. No drawdown announced. Strikes paused, not cancelled. | NEUTRAL |
| Diplomatic channel | Witkoff/Kushner back-channel is new. First confirmed engagement since Larijani assassination. | BULL |
| Weekend violence | Iran’s 70th wave hit Arad/Dimona. IRBMs at Diego Garcia. 1,444+ killed. War continues despite talks. | BEAR |

### Panel 7

| Ticker | Company | Pre-Mkt | Catalyst |
| --- | --- | --- | --- |
| COHR | Coherent | +6–8% | S&P 500 inclusion today. Passive fund buying. NVDA $2B investment backdrop. |
| LITE | Lumentum | +5–7% | S&P 500 inclusion today. Multi-year NVDA purchase commitment. |
| VRT | Vertiv | +4–6% | S&P 500 inclusion today. AI power/cooling demand secular. |
| XOM | Exxon Mobil | −5–7% | Oil crash. Brent −14% intraday. Energy sector reversal. |
| CVX | Chevron | −4–6% | Oil selloff. But still +30% YTD on war premium. |
| OXY | Occidental | −6‒8% | Highest beta to oil. Hardest hit on Brent collapse. |
| HAL | Halliburton | −5–7% | OFS names selling off on ceasefire hopes. |
| LMT | Lockheed Martin | −3‒4% | Defence unwind on ceasefire signal. Still overweight. |
| DAL | Delta Air Lines | +4–6% | Airlines rip on jet fuel crash. Biggest beneficiary of oil drop. |
| UAL | United Airlines | +4–5% | Jet fuel relief rally. Consumer travel names bid. |
| INSM | Insmed | +11.5% | Top premarket gainer. Pipeline catalyst (unrelated to war). |
| MU | Micron | +2–3% | Bouncing from post-earnings selloff. AI demand thesis intact. |

### Panel 8

| # | Headline |
| --- | --- |
| 1 | Trump postpones Iran strikes for 5 days, says talks are “very good”; demands uranium surrender |
| 2 | Brent crude crashes 14% intraday to ~$97—biggest single-day drop since April 2020 |
| 3 | Iran denies talks, calls Trump’s claims “market manipulation”; Ghalibaf rejects negotiation framing |
| 4 | S&P 500 futures surge +2.7% on ceasefire hopes; Nasdaq +3.1%; VIX crushed to 26.8 |
| 5 | S&P 500 rebalance effective today: COHR, LITE, VRT, SATS added; MTCH, MOH, LW, PAYC removed |
| 6 | Treasury Sec. Bessent lifts sanctions on 140M barrels of stranded Iranian oil to ease prices |
| 7 | Iran’s 70th wave of attacks over weekend: Arad/Dimona hit, IRBMs fired at Diego Garcia (missed) |
| 8 | 1,444+ killed in Iran since Feb 28, including 204 children; war enters Day 24 |
| 9 | Airlines surge premarket (DAL +5%, UAL +5%) on jet fuel cost collapse |
| 10 | Energy stocks crater: XOM −6%, OXY −7%, HAL −6% on oil reversal |
| 11 | GameStop (GME) earnings tomorrow AMC; M&A speculation building ahead of report |
| 12 | S&P Global Flash PMI (March) due 9:45 AM—first read on post-FOMC business conditions |
...
| --- | --- | --- | --- |
| Mon 3/23 | Pre-Mkt | S&P 500 Rebalance: COHR, LITE, VRT, SATS Added | HIGH |
| Mon 3/23 | 9:45 AM | S&P Global Flash PMI (Mar) | MED |
| Mon 3/23 | All Day | Ceasefire Window Day 1 of 5 | HIGH |
| Tue 3/24 | 10:00 AM | New Home Sales (Feb) | LOW |
| Tue 3/24 | 10:00 AM | Consumer Confidence (Mar) | MED |
...
| Fri 3/27 | 8:30 AM | Core PCE Inflation (Feb) — Fed’s Preferred Gauge | HIGH |
| Fri 3/27 | 10:00 AM | UMich Consumer Sentiment Final (Mar) | MED |
| Fri 3/27 | All Day | Ceasefire Window Day 5 — DEADLINE | HIGH |
| Fri 3/27 | All Day | War Day 28 — 1 Month Anniversary of Conflict | HIGH |
